...
class Activities extends Controller {
	...
	/** @var \OCA\OobActivity\GroupHelper */
	protected $helper;

	/** @var \OCA\OobActivity\Navigation */
	...
	public function showList($filter = 'all') {
		...
		return new TemplateResponse('oobactivity', 'list', [
	...
	public function fetch($page, $filter = 'all') {
		...
		return new TemplateResponse('oobactivity', 'activities.part', [
			'oobactivity' => $this->data->read($this->helper, $this->settings, $pageOffset * self::DEFAULT_PAGE_SIZE, self::DEFAULT_PAGE_SIZE, $filter)
		], '');
	}
}
