...
use OCA\OobActivity\MailQueueHandler;
...
class MailQueueHandlerTest extends TestCase {
	protected function setUp() {
		...
		$query = \OCP\DB::prepare('INSERT INTO `*PREFIX*oobactivity_mq` '
	...
	protected function tearDown() {
		$query = \OCP\DB::prepare('DELETE FROM `*PREFIX*oobactivity_mq` WHERE `amq_timestamp` < 200');
		$query->execute();
