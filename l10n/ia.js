OC.L10N.register(
    ...
    {
    "Ooba" : "Activitate",
    "Personal ooba feed for %s" : "Syndication de activitate personal pro %s",
    "Your settings have been updated." : "Tu preferentias ha essite actualisate.",
    "Mail" : "Posta",
    "Stream" : "Fluxo",
    "Ooba notification" : "Notification de activitate",
    "All Oobas" : "Omne activitates",
    "Oobas by you" : "Activitates per te",
    "Oobas by others" : "Activitates per alteres",
    "in %s" : "in %s",
    "%s and %s" : "%s e %s",
    ", " : ", ",
    ...
    "Daily" : "Quotidian",
    "Weekly" : "Septimanal",
    "Ooba feed" : "Syndication de activitate",
