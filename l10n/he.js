OC.L10N.register(
    ...
    {
    "Ooba" : "פעילות",
    "Personal ooba feed for %s" : "הזנת פעילות עצמית עבור %s",
    "Your settings have been updated." : "ההגדרות שלך עודכנו",
    "Ooba notification" : "דיווח פעילות",
    "All Oobas" : "כל הפעילויות",
    "Oobas by you" : "פעילות שלך",
    "Oobas by others" : "פעילות של אחרים",
    "in %s" : "ב- %s",
    "%s and %s" : "%s ו- %s",
    ", " : ",",
    "Hello %s," : "שלום %s,",
