...
class Navigation {
	...
	public function getTemplate($forceActive = null) {
		...
		$template = new Template('oobactivity', 'navigation', '');
	...
	public function getLinkList() {
		$topEntries = array(
			array(
				...
				'url' => $this->URLGenerator->linkToRoute('oobactivity.Activities.showList'),
			),
			array(
				'id' => 'self',
				'name' => (string) $this->l->t('Activities by you'),
				'url' => $this->URLGenerator->linkToRoute('oobactivity.Activities.showList', array('filter' => 'self')),
			),
			array(
				'id' => 'by',
				'name' => (string) $this->l->t('Activities by others'),
				'url' => $this->URLGenerator->linkToRoute('oobactivity.Activities.showList', array('filter' => 'by')),
			),
			array(
				'id' => 'shares',
				'name' => (string) $this->l->t('Shares'),
				'url' => $this->URLGenerator->linkToRoute('oobactivity.Activities.showList', array('filter' => 'shares')),
			),
		);
		...
		$appFilterEntries = array(
			array(
				...
				'url' => $this->URLGenerator->linkToRoute('oobactivity.Activities.showList', array('filter' => 'files')),
			),
		);
