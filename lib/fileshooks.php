...
use OC\Files\View;
use OCA\Ooba\Extension\Files;
use OCA\Ooba\Extension\Files_Sharing;
...
class FilesHooks {
	 ...
	 */
	public function __construct(IManager $manager, Data $oobaData, UserSettings $userSettings, IGroupManager $groupManager, View $view, IDBConnection $connection, $currentUser) {
		$this->manager = $manager;
		$this->oobaData = $oobaData;
	 ...
	 * @param int    $oobaType     The ooba type
	 * @param string $subject          The subject for the actor
	 * @param string $subjectBy        The subject for other users (with "by $actor")
	 */
	protected function addNotificationsForFileAction($filePath, $oobaType, $subject, $subjectBy) {
		// Do not add oobas for .part-files
		...
		$filteredStreamUsers = $this->userSettings->filterUsersBySetting(array_keys($affectedUsers), 'stream', $oobaType);
		$filteredEmailUsers = $this->userSettings->filterUsersBySetting(array_keys($affectedUsers), 'email', $oobaType);
	...
	/**
	 * Adds the ooba and email for a user when the settings require it
	 *
	 * @param string $user
	 * @param string $subject
