...
use ACTIVITYDB\DB;
require_once 'apps/activity/lib/db/public/db.php';
...
class MailQueueHandlerTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$query = \ACTIVITYDB\DB::prepare('INSERT INTO `*PREFIX*activity_mq` '
	...
	public function tearDown() {
		$query = \ACTIVITYDB\DB::prepare('DELETE FROM `*PREFIX*activity_mq`');
		$query->execute();
