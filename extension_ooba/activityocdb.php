<?php
/**
 * This class is a modified copy of owncloud/lib/private/db.php, to be exclusively used by oobactivity app.
 */
...
class Activity_OC_DB {
	...
	static public function getConnection() {
		...
		return ActivityHelper::getDatabaseConnection();
	}
	...
	private static function getMDB2SchemaManager() {
		...
		//syslog(LOG_INFO,'1---');
		return new \OC\DB\MDB2SchemaManager(ActivityHelper::getDatabaseConnection());
	}
	...
	static public function prepare( $query , $limit = null, $offset = null, $isManipulation = null) {
		...
		$connection = ActivityHelper::getDatabaseConnection();
	...
	public static function insertid($table=null) {
		...
		return ActivityHelper::getDatabaseConnection()->lastInsertId($table);
	...
	public static function beginTransaction() {
		...
		return ActivityHelper::getDatabaseConnection()->beginTransaction();
	}
	...
	public static function commit() {
		...
		return ActivityHelper::getDatabaseConnection()->commit();
	}
	...
	public static function rollback() {
		...
		return ActivityHelper::getDatabaseConnection()->rollback();
	}
